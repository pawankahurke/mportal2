...
csrf_check_custom();
$_SESSION['windowtype'] = 'patchmanagement';
$_SESSION['currentwindow'] = 'patchmanagement';
...
<?php require_once 'mum_html.php'; ?>
<?php require_once '../layout/footer.php'; ?>

<script src="../js/rightmenu/rightMenu.js"></script>
<?php
$res = nhRole::checkModulePrivilege('patchmanagement');
if ($res) {
?>
...
<script type="text/javascript">
    $('#pageName').html('Patch Management');
</script>