        ...
        <div class="col-md-12 pl-0 pr-0">
            <div class="card">
                <div class="card-body">
                    ...
                    <table class="nhl-datatable table table-striped" width="100%" data-page-length="25" id="detaild_grid">
                        <thead>
                            <tr>
...
<div id="site-add-container" class="rightSidenav" data-class="sm-3">
    <div class="card-title border-bottom">
        <h4>Add</h4>
        <a href="javascript:void(0)" class="closebtn rightslide-container-close border-0" data-target="site-add-container">&times;</a>
    </div>
    <div class="btnGroup">
