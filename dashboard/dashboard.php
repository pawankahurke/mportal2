...
$_SESSION['windowtype'] = 'dashboard';
$_SESSION['currentwindow'] = 'dashboard';

$res = checkModulePrivilege('dashboard', 2);
if (!$res) {
...
<!-- <script type="text/javascript" src="../js/dashboard/dashboard_new.js"></script> -->
<script type="text/javascript">
    var loggedUserId = '<?php echo $_SESSION['user']['userid']; ?>';
    var tempid = '<?php echo $kibana_url; ?>';
    $('#pageName').html('Manage Dashboard');
