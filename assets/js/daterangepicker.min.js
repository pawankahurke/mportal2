...
!(function (t, e) {
  ...
  var a = function (a, i, s) {
    ...
    'function' == typeof s && (this.callback = s),
      this.timePicker ||
        ((this.startDate = this.startDate.startOf('day')), (this.endDate = this.endDate.endOf('day')), this.container.find('.calendar-time').hide()),
      ...
      move: function () {
        ...
        switch (
          (this.parentEl.is('body') ||
            ((a = { top: this.parentEl.offset().top - this.parentEl.scrollTop(), left: this.parentEl.offset().left - this.parentEl.scrollLeft() }),
        ...
        if (e(t.target).hasClass('available')) {
          ...
          if (this.endDate || n.isBefore(this.startDate, 'day')) {
            if (this.timePicker) {
              ...
              if (!this.timePicker24Hour)
                'PM' === (l = this.container.find('.left .ampmselect').val()) && r < 12 && (r += 12), 'AM' === l && 12 === r && (r = 0);
            ...
            if (this.timePicker) {
              ...
              if (!this.timePicker24Hour)
                'PM' === (l = this.container.find('.right .ampmselect').val()) && r < 12 && (r += 12), 'AM' === l && 12 === r && (r = 0);
        ...
        if (i) {
          ...
          h.hour(s),
            ...
            this.singleDatePicker
              ...
              : this.endDate && this.endDate.format('YYYY-MM-DD') == h.format('YYYY-MM-DD') && this.endDate.isBefore(h) && this.setEndDate(h.clone());
