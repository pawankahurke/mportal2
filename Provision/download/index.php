...
$sql = "select se.siteemailid, s.brandingurl from " . $GLOBALS['PREFIX'] . "install.Sites s left join " . $GLOBALS['PREFIX'] . "install.Siteemail se on s.siteid = se.siteid where se.siteemailid = $siteemailid limit 1;";
$res = redcommand($sql, $db);

if ($res) {
    $row = mysqli_fetch_assoc($res);
    $data = $row['brandingurl'];
...
<head>
    ...
    <link rel="shortcut icon" href="https://<?php echo $DOMAIN . "\/Dashboard" ?>/Provision/download/favicon.ico">
...
<body>
    <header style="background-color: #050d30;">
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="logo">
                        <!--<a href="#"><img src="https://dashboard-test.selfheal.compucom.com/Dashboard/vendors/images/compucom-logo1.png" alt=""></a>-->
                        <a href="#"><img style="width: 30px;" src="<?php echo getenv('VISUALISATION_SERVICE_API_URL') . "/dashboard-customization/menu-logo.png" ?>" alt="Header Logo..." /></a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                </div>
    ...
    <div id="downloadDiv" data-copycon="true" class="login-page login-compu">
        <img src="<?php echo getenv('VISUALISATION_SERVICE_API_URL') . "/dashboard-customization/bg.jpg" ?>" alt="">
        <div class="login-box login-box-left clearfix" style="color : white;font-size: 16px;">
            <div style="padding-right: 0px;" class="login-left" id="successDiv">
                <!--<h2>Selfheal</h2>-->
                ...
                <div class="action" id="actionDiv">
                    <div style="display:flex; justify-content:space-between;" class="input-group clearfix scan-agins" onmousedown="return false">
                        <button style="margin: 0px;" disabled="true" type="button" class="btn btn-lg cancel-btn btn_cancel">Cancel</button>
                        <button style="margin: 0px;" type="submit" class="btn btn-lg sign-in-btn btn_download" onclick="downloadClient();">Download Now</button>
    ...
    <script>
        function downloadClient() {
            location.href = "download_helper.php?rcode=<?php echo $regCode; ?>&seid=<?php echo $siteemailid; ?>";
        }
