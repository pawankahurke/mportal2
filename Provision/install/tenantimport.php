...
echo install_html_header_slave($title, $comp, $authuser, $priv_admin, $priv_servers, $db);
if (trim($msg))
...
$args[] = "<form method='post' action='user-setup.php' name='myForm'>\n" .
    "<input type='hidden' name='action' value='importtenantkey'>\n" .
    "<input type='submit' value='Import'>";
table_data($args, 0, 'left');
table_footer();

table_header();
$args = array('<b>Import Tenant Activation Key:</b> ', "<textarea id='tenantactkey' name='tenantactkey' style='width:500px; height:150px; resize:none;'></textarea>");
table_data($args, 0, 'left');
