...
$args[] = "<form method='post' action='cust-act.php' name='myForm'>\n" .
    "<input type='hidden' name='action' value='importcustlicense'>\n" .
    "<input type='submit' value='Import'>";
table_data($args, 0, 'left');
table_footer();

table_header();
$args = array('<b>Customer Key:</b> ', "<textarea id='custkey' name='custkey' style='width:500px; height:150px; resize:none;'></textarea>");
table_data($args, 0, 'left');
