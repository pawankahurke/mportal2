...
Date        Who     What
----        ---     ----
24-Feb-07   BTE     Copied from l-head.php.  This will be the new HTML valid
                    l-head.php.  New server pages should include l-head2.php
                    instead of l-head.php.  Eventually, all pages will use this
                    file instead.
Comments from l-head.php:
...
15-Apr-07   BTE     Merged in SAK change: Bug 4019:  Increased the size of the
                    "How to" button.
09-May-07   BTE     Use default.css instead of inline css.
...
NOTICE: remember to make your change to l-head.php if it applies!
*/
...
/* custom_html_header
        ...
        Creates the <html> and <head> section and starts the <body>.

        $title = title of the page
        $comp = the component of the server
        $authuser = user information about the currently logged in user
        $local_nav = the local navigation bar
        $local_inf = local information to include after the local navigation
            bar
        $legend = image path
        $nocache = controls page cache
        $headtxt = additional HTML to add just before closing the <head>
