...
Date        Who     What
----        ---     ----
 5-May-03   NL      Initial creation.
 5-May-03   NL      Increase window.timeout delay to 250 millisecs.
 5-May-03   NL      Increase window.timeout delay to 500 millisecs.
28-May-03   NL      Rename outputJavascriptShowElement() to JS_HideShow();
                    Add delay (in milliseconds) parameter as an optional argument
 1-Dec-04   EWB     A here document.
*/
