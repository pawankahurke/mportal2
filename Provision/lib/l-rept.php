...
/* Helpful functions and constants for the REPT C-interface.  This file
    contains copied constants from iface/rept.h.

Revision history:

Date        Who     What
----        ---     ----
16-Nov-06   BTE     Original creation.
28-Sep-07   BTE     Added REPT_MakeMUMSectionArray and some constants.

*/

/* ALIST item names for REPT_CreateReportParam */
...
/* ALIST item names for REPT_AddReportComponentParam */
...
/* ALIST item names for REPT_AddReportComponentColParam */
...
/* Definitions for REPORT.outputFormat */
define('constReptOutputFormatHTML',     1);

/* Definitions for REPCOMPCOL.colLocationFormat */
...
/* Definitions for REPCOMPCOL.colFormat/colNameFormat */
...
/* REPT_AddComponentCol

        Adds a column to a report component.
    */
...
/* REPT_CreateNullHandleList

        Translates a PHP array containing NULL definitions into an ALIST.
    */
...
/* REPT_PrintError
        ...
        Prints the generic user visible error message.
    */
...
/* REPT_MakeMUMSectionArray

        Populates the javascript mumSectionsArray with a list of MUM sections.
    */
