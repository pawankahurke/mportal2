...
When:       Who:   What:
-----       ----   -----
18-Jan-06   BJS    Created.

*/
    /*
     | Files that have lots of UI text and such can be stored here.
     | This file began when l-syst.php started filling up with such
     | definitions.
    */
    ...
    */
    ...
    /* l-syst.php:
     |
     | Error Messages, Directions & Explanations.
    */
    ...
    /* ftp pasv & email subject never cause errors */
