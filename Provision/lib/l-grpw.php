...
16-Jun-04   EWB     Create WUConfig records.
17-Jun-04   EWB     site and host links work.
18-Jun-04   EWB     create and edit PatchConfig records.
21-Jun-04   EWB     find correct wconfig record for machine.
24-Jun-04   EWB     edit manual patch group membership works.
25-Jun-04   EWB     check all / uncheck all buttons work.
28-Jun-04   EWB     patch group expressions
29-Jun-04   EWB     delete patch category
30-Jun-04   EWB     Delete pcfg / wcfg records.
30-Jun-04   EWB     Column sort list_pcfg, show_cat_pgrp
 1-Jul-04   EWB     Column sort list_wcfg, copy wcfg
 2-Jul-04   EWB     confirm copy wcfg, confirm copy pcfg, copy pcfg.
 6-Jul-04   EWB     Added text explanations for selected pages.
 7-Jul-04   EWB     Automatic generation of new patch groups.
 8-Jul-04   EWB     automatic rebuild of patch/machine groups.
 9-Jul-04   EWB     update patch group command.
13-Jul-04   EWB     Fixed a bug with WUConfig.newpatches.
14-Jul-04   EWB     moved installdelay from wcfg to pcfg
19-Jul-04   EWB     many changes to PatchConfig table.
20-Jul-04   EWB     month options range from 1 to 31.
28-Jul-04   EWB     wizard command to change ALL schedules.
29-Jul-04   EWB     wizard reset command.
30-Jul-04   EWB     stubs for all wizard pages.
30-Jul-04   EWB     wizard beta site.
 3-Aug-04   EWB     added schedule to wizard uninstall page.
 4-Aug-04   EWB     touch up for wizard download control form.
 4-Aug-04   EWB     wiz_rem_disp and friends ...
 5-Aug-04   EWB     wiz_proxy and associates.
 9-Aug-04   EWB     more wizard changes.
10-Aug-04   EWB     wizard beta uses hours/days/weeks
11-Aug-04   EWB     invalidate pcache
12-Aug-04   EWB     expanded "install critical" wizard.
13-Aug-04   EWB     expanded "remove troublesome" wizard.
17-Aug-04   EWB     wizard download proxy rewritten from scratch.
18-Aug-04   EWB     The server no longer attempts to invalidate the cache.
18-Aug-04   EWB     expanded "propagation between machines" wizard.
24-Aug-04   EWB     update wizard lables.
25-Aug-04   EWB     generic wizard dispatch.
25-Aug-04   EWB     added creation date to mgrp/pgrp.
25-Aug-04   EWB     wizard update all becomes update every.
26-Aug-04   EWB     rewrite overall strategy command.
27-Aug-04   EWB     gang assign for clone mgrp/pgrp, copy pgrp.
30-Aug-04   EWB     non-javascript machine group selection.
 1-Sep-04   EWB     populate new machine group by checkbox.
 2-Sep-04   EWB     support for new wcfg fields.
 7-Sep-04   EWB     add site to group page shows site totals.
 8-Sep-04   EWB     intermediate action page.
 9-Sep-04   EWB     wizard scope can edit existing machine groups.
10-Sep-04   EWB     machine group details.
11-Sep-04   EWB     added schedule to wizard approve.
13-Sep-04   EWB     removed PatchConfig.schedfail
13-Sep-04   EWB     no more backup groups.
16-Sep-04   EWB     wizard propagation sets cache seconds.
21-Sep-04   EWB     proxy wizard removed.
23-Sep-04   EWB     Show machines in wizard select mgrp page.
27-Sep-04   EWB     Format of wizard group individual confirmation.
30-Sep-04   EWB     Critical wizard push a different button
 5-Oct-04   EWB     a/r/c/d wizards restrict by pgrp / size
 6-Oct-04   EWB     ditto platform / component / priority
21-Oct-04   EWB     small tags change in again()
25-Oct-04   EWB     kill certain status records when wcfg.psrc changes.
28-Oct-04   EWB     fixed bug 2375
29-Oct-04   EWB     enable / disable beta test wizard (#2378)
 2-Nov-04   EWB     moved a lot of code into l-pcfg.php
 3-Nov-04   EWB     wizard status page contains all 7 tables.
 4-Nov-04   EWB     delete from status page return to status page
 4-Nov-04   EWB     notify delay always tracks schedule delay.
 5-Nov-04   EWB     gang of four links from wizard status work.
 5-Nov-04   EWB     direct editing of pcfg schedule.
 8-Nov-04   EWB     update beta delay from wizard status page.
 8-Nov-04   EWB     propagation policy from wizard status page.
 9-Nov-04   EWB     column sorting in status page.
 9-Nov-04   EWB     (#2384) restrict gang of four to patches detected at mgrp
 9-Nov-04   EWB     (#2385) added schedule to removal wizard.
11-Nov-04   EWB     mgrp_details allows user to modify machine group.
17-Nov-04   EWB     handles case of user sans appropriate sites.
18-Nov-04   EWB     reorder pgrp precedence requires admin priv.
19-Nov-04   EWB     pseudo-wizard for editing machine groups.
22-Nov-04   EWB     wizard status edit schedule scrolls to relevent section
24-Nov-04   EWB     pcfg inherits from user, then all, then default.
20-Dec-04   EWB     Show date of last change on wizard status page.
22-Dec-04   EWB     range wcfg.cacheseconds 1..31 days
28-Dec-04   BTE     Added restart policy to machine configuration page, added
                    chaining options to patch configuration page.
29-Dec-04   BTE     Moved chaining options from patch config page to machine
                    config page.
 3-Jan-05   EWB     changed "reboot" to "restart"
 4-Jan-05   EWB     Added status link for quad selection page.
 4-Jan-05   EWB     Remove wizard restricts to installed patches by default.
27-Jan-05   EWB     Beta status wizard doesnt create user pcfg.
 3-Feb-05   EWB     Added Alex help text
10-Feb-05   EWB     Issue a warning when changing names.
12-Feb-05   EWB     Remove wizard updates correct pcfg schedule.
15-Feb-05   BJS     Added link to enab/disab ms updates
21-Feb-05   EWB     Additional logging of patch events.
22-Feb-05   EWB     Fixed a serious bug in wiz_prop_act()
22-Feb-05   EWB     Logging of wizard events, update pcfg, update wcfg
 5-Apr-05   EWB     Set default value of dtc/int flags from status page.
 8-Apr-05   BJS     Added global machine groups option.
 6-May-05   EWB     force-update button uses gconfig database.
 1-Jun-05   EWB     force-update button clears legacy cache
11-Jul-05   EWB     fixed jmk memory problem
29-Aug-05   BJS     Added a link for Alex.
12-Sep-05   BTE     Added checksum invalidation code.
14-Sep-05   BTE     Removed the unused function mcat_update_precedence.
15-Sep-05   BJS     Added l-grpw.php
^Comments from wu-confg.php
15-Sep-05   BJS     Created from wu-confg.php
16-Sep-05   BJS     More decision making based on pageEntry.
20-Sep-05   BTE     Added proper table specification in force_update.
22-Sep-05   BJS     Added wiz_conf_del(), wiz_sites_confirm().
                    Removed pageEntry & replaced with custom.
26-Sep-05   BJS     Replaced done_link() w/cancel_link().
12-Oct-05   BTE     Changed references from gconfig to core.
24-Oct-05   BJS     find_mgrp_gid() takes 3rd argument.
25-Oct-05   BJS     Added parens in wiz_beta_act(), fixed bug where
                    machine group lists where not getting updated
                    when returning to a notification from the wizard.
03-Nov-05   BJS     Added abilty to remove a groups mgroupid from
                    any Notification and/or Report it is contained in.
04-Nov-05   BJS     Moved code into proc GRPS_find_machines_from_mgroupid.
...
11-Nov-05   BJS     Page titles and links generated by value of $custom, GRPW_return_title.
02-Dec-05   BJS     Added support for Asset Report groups.
08-Dec-05   BJS     Added support for scrpconf.php
14-Dec-05   BJS     GRPW_display_buttons() has 3 argvs.
15-Dec-05   BJS     'show members' option now avaiable from tools:groups
                    and scrpconf.php, which takes you to chckconf.php
20-Dec-05   BJS     Missing break statement caused duplicate action entries.
26-Jan-06   BTE     Bug 3059: Redesign DSYN and tables to "remotable" internal
                    pointers.
27-Jan-06   BTE     New parameter for insert_mgrp.
01-Feb-06   BJS     Fixed overwritten code, SSS ability to enter group config.
...
14-Apr-06   BTE     Added some missing "level" tracking.
...
23-May-06   BTE     Bug 3360: Cannot remove a machine from an user-defined
                    group.
24-May-06   BTE     Bug 3382: Errors on CI log.
07-Jul-06   BTE     Bug 3483: MUM: Include all patches on approval list.
19-Jul-06   BTE     Bug 3239: 913 errors on CI server.
01-Sep-06   BTE     Bug 3649: Fatal error running select update method wizard.
20-Sep-06   BTE     Bug 2826: Make MUM approve/decline wizards a little easier
                    to use (not so large).
02-Oct-06   BTE     Bug 3679: Block an user from using overlapping type groups
                    in the wizard.
09-Oct-06   BTE     Bug 3680: Peform exhaustive testing of type groups and
                    wizards.
...
31-Oct-06   BTE     Bug 3794: Finish server for first customer release of MUM
                    changes.
03-Nov-06   BTE     Text changes from Alex.
03-Nov-06   BTE     Added hyperlinks to text from Alex.
05-Dec-06   BTE     Bug 3612: Text change for MUM notification page.  Bug 3771:
                    MUM: Add analysis link to update selection pages.
09-Dec-06   BTE     Bug 3842: Make mandatory an update attribute.  Bug 3843:
                    MUM update selection pages need to be mix and match.
14-Dec-06   BTE     Bug 3941: MUM: Extensive testing for new mandatory groups.
...
*/
   ...
   /*
    |  menu: default entrance
    |  awid: create new wcfg, select gid
    |  apid: create new pcfg, select gid/jid
    |  cwid: create new wuconfig, confim create
    |  iwid: insert into WuConfig.
    |  ewid: edit existing wcfg, select gid
    |  epid: edit existing pcfg, select gid, jid
    |  fwid: wcfg form
    |  fpid: pcfg form
    |  cata: add pcat form
    |  catb: add pcat conf
    |  catc: add pcat act
    |  lwid: list existing wcfg
    |  lpid: list existing pcfg
    |  site: edit wuconfig for site, or ask if we want to create it.
    |  host: edit wuconfig for host, or ask if we want to create it.
    |  pcat: edit pgrp categories
    |  upga: update (recalculate) patch group
    |  init: create initial pcat/pgrp
    */
   ...
   /*
    ...
    | $grp    = group
    |
    | This generates the title for each page.
    | A single action ($act) within the wizard can yield different results.
    | Those results are generated based on the value of $custom, which is
    | set by constPageEntryxxxxx. (read l-grps.php for more info).
    | Any page that calls into the wizard & starts at /config/groups.php
    | will call GRPW_return_title to generate the title.
    | Here we make the title distinction for any custom variable, otherwise
    | we default to the stock title.
   */
   ...
   /*
    |  This is one of those things which will be helpful
    |  at first ... but since it's on EVERY page the poor
    |  user will probably get sick of seeing it and wish
    |  there was some way to turn it off.
    */
...
XXXX;
   ...
   /*
    ...
    |
    | This proc is diplayed on every page of the wizard.
    | In some cases, such as entering the wizard via the
    | reports or notifications pages, we dont' want to
    | display text relating to the Micrsoft Wizard or
    | similiar...
   */
    function again(&$env)
    {
        ...
        {
           /*
            | we only want to display the MSU status link
            | to those who came from WUconfg
           */
	    case constDashStatus_SelectMachineGroup : ;
   ...
   /*
    |  edit config machine group
    |  edit config patch group
    |  list all patch configurations
...
MENU;
   ...
   /*
    |  spooky javascript ... causes the form to
    |  submit when the user changes the selection.
    */
...
AWID;
    ...
    |
    |  The routine should always return true for admin users.
    |  Really, we don't even need to check ... however we still
    |  want to see the output of mgrp_alien at debug time.
    |
    |  So ... we run slow at debug time and fast otherwise.
    */
   ...
   //   echo para("There are $num sites.");
    ...
    function wiz_site_frm(&$env,&$mgrp,&$mcat,$db)
    {
        ...
        if (($mgrp) && ($mcat) && ($cids))
        {
            ...
            /*
             | If we came from scprconf.php, we want to return
             | their now that we've picked and configured a mgroupid.
            */
	    switch( $custom )
	    {
	        case constPageEntryScrpConf :
...
WBOX;
    ...
    |  $mgrp = machine group variable array in the form:
    |  [mgroupid] => 20
    |  [mcatid]   => 5
    |  [name]     => Group 001
    |  [username] => hfn ....
    |  $db   = database handle
    |
    |  Before we delete a group, the user must confirm the action.
    |  Present two links [Yes] and [No].
    |
    |  We must also must check to see if the group the user is trying
    |  to delete is part of a notification. If so we must remove the
    |  mgroupid from all Notifications that contain it. It can no longer
    |  be referenced.
    */
    function wiz_conf_del(&$env, &$mgrp, $db)
    {
        ...
        /* is the mgroupid the user is  deleting contained in a report */
        ...
        if (($cid) && ($mgrp) && ($site))
        {
            ...
            if ($set)
            {
                ...
                if($set)
                {
                    foreach ($set as $key => $row)
                    {
                        $err = PHP_VARS_HandleDeletedGroup(CUR,
                            $row['censusuniq'], $row['mgroupuniq']);
                        if($err!=constAppNoErr)
                        {
                            logs::log(__FILE__, __LINE__, "wiz_site_del: "
    ...
    function wiz_mgrp_del(&$env,&$mgrp,&$mcat,$db)
    {
        if ($mgrp)
        {
            ...
            if (delete_mgrp_gid($gid,$db))
            {
                if ($rnid)
                {
                    /* remove mgroupid from all Notifications in $rnid */
                ...
                if ($enid)
                {
                    /* remove mgroupid from all Reports in $enid */
                    GRPS_remove_mgroupid_from_event($gid, $enid,
                                                    constEventReports, $db);
                }
                if ($anid)
                {
                    /* remove mgroupid from all Asset Reports in $anid */
   ...
   /*
    |  This does the subroutine stuff to take care
    |  of populating the new machine group.
    */
   ...
   /*
    |  20-Dec-04 EWB:  It was decided by the powers that be that
    |  the "all my machines" scope will NOT be available to admin
    |  users ... and that we will just lie to the non-admin
    |  and call the user group "All machines".
    |
    |  I personally think that calling two different groups
    |  by the same name will eventually lead to confusion ...
    |  but I've been overuled.
    */
...
SCOP;
   ...
   /*
    | custom = the page where we came from
    | When entering the group wizard from scrpconf
    | we want to change the buttons.
   */
   ...
   /*
    |  Theres a few cases were we want to insist that
    |  the scope must be a subset of all.
    */
...
WMTH;
    ...
    /* present the return  Asset Reports link */
    ...
    /* present the return to notifications link */
    ...
    /* present the return to reports link */
    ...
    function wiz_meth_form(&$env,$db)
    {
        ...
        if ( ($mgrp) || (($pgrp) && ($pcfg)) )
        {
            /* If we started at sites:wizard
            |                        (custom = 2 = constPageEntrySites)
            |                or tools:groups
            |                        (custom = 3 = constPageEntryTools)
            |                or event:notifications
            |                        (custom = 5 = constPageEntryNotfy)
            |                or event:reports
            |                        (custom = 6 = constPageEntryReports)
            |                or event:asset
            |                        (custom = 7 = constPageEntryAsset)
            |  we are done. Present the finish page.
            */
	    if ($mgrp)
            {
	        $name = $mgrp['name'];
   ...
   /*
    |  This is normally called from the beta wizard but sometimes it
    |  can be called from the status wizard.  In that case we are
    |  short-circuiting the state machine and should just post
...
/*
            echo "<b>Current Delay</b><br>\n"
              .  "${in}Weeks: <b>$ww</b><br>\n"
              .  "${in}Days: <b>$dd</b><br>\n"
              .  "${in}Hours: <b>$hh</b>\n";
            echo "<br><br>\n"
              .  "<b>Current State</b><br>\n"
              .  "${in}Wizard: <b>$enab</b><br>\n"
...
XXXX;
   ...
   /*
    |  For Approve / Decline / Critical we want
    |     (lastinstall = 0) and (detected > 0)
    |  For Remove
    |     (lastinstall > 0) and (detected > 0)
    */
...
YYYY;
    ...
    function wiz_build(&$env,&$mgrp,$db)
    {
       ...
       /*
        |  (#2384) restrict patches to those which have been
        |  detected at the machine group in question.
        */
       ...
       /*
        ...
        |    critical (highest)
        |
        |  We don't need to do anything special about
        |  precedence since these groups should be
        |  disjoint anyway.
        */
    ...
    function wiz_status_table(&$env,&$wiz,$word,$xjid,$head)
    {
       ...
       /*
        |  We need a whole lot of context to get back here, so
        |  the column-sorting links will be very big.
        */
        ...
        $date = ($ord ==  2)? "$o=3"  : "$o=2";   // date   2,  3
        $comp = ($ord ==  4)? "$o=5"  : "$o=4";   // comp   4,  5
        $plat = ($ord ==  6)? "$o=7"  : "$o=6";   // plat   6,  7
        $size = ($ord ==  8)? "$o=9"  : "$o=8";   // size   8,  9
        $prio = ($ord == 10)? "$o=11" : "$o=10";  // prio  10, 11
        $canu = ($ord == 12)? "$o=13" : "$o=12";  // canu  12, 13
        ...
        foreach ($mids as $mid => $name)
        {
            ...
            /* Generate a link to the INSW wizard, but if any call fails, do
                not abort the page (just don't display the link */
            $noError = true;
            $err = PHP_INSW_GetActStr(CUR, $actStr, constMUMIntMachineStart);
            if($err!=constAppNoErr)
            {
                $noError = false;
                logs::log(__FILE__, __LINE__, 'wiz_status_table: PHP_INSW_GetActStr failed with '
                    . "$err", 0);
            }
            ...
            {
                $noError = false;
                logs::log(__FILE__, __LINE__, 'wiz_status_table: PHP_INSW_GetPatchIDStr failed '
                    . 'with ' . "$err", 0);
            }
            ...
            {
                $noError = false;
                logs::log(__FILE__, __LINE__, 'wiz_status_table: PHP_INSW_GetEndpointStr failed '
                    . 'with ' . "$err", 0);
            }
    ...
    function show_changes($env,&$mids,$wpgroupid,$txt,$db)
    {
        ...
        if($changes)
        {
            ...
            if($err!=constAppNoErr)
            {
                logs::log(__FILE__, __LINE__, "PHP_AUDT_LogLocalAudit failed for MUM group: $err",
                    0);
            }
        }
    }
   ...
   /*
    |  Any specified machine group can have four
    |  associated wizard patch groups which will
    |  be known as
    |
    |    approve / decline / remove / critical
    |
    |  Any particular patch should be in at most
    |  one of these.  We preserve that by always
    |  removing from three before adding to one.
    */
...
MARK;
   ...
   /*
    |  This has the effect of clicking on the scrip 237 "run now" button
    |  for all the affected machines.  We do the complex join at the
    |  beginning to figure out exactly what needs to change ... so
    |  we can do the actual job with just three small statements.
    */
    ...
    function force_update(&$env,&$mgrp,$db)
    {
        ...
        $grp = $mgrp['name'];
        $gid = $mgrp['mgroupid'];
        $sql = "select X.site, X.host,\n"
             . " R.ctime, R.stime, S.* from\n"
             . " ".$GLOBALS['PREFIX']."core.Census as X,\n"
             . " ".$GLOBALS['PREFIX']."core.MachineGroups as G,\n"
             . " ".$GLOBALS['PREFIX']."core.MachineCategories as C,\n"
             . " ".$GLOBALS['PREFIX']."core.MachineGroupMap as M,\n"
             . " ".$GLOBALS['PREFIX']."core.Revisions as R,\n"
             . " ".$GLOBALS['PREFIX']."core.SemClears as S,\n"
             . " ".$GLOBALS['PREFIX']."core.Variables as V\n"
             . " where M.mgroupuniq = G.mgroupuniq\n"
             . " and G.mgroupid = $gid\n"
             . " and S.censusuniq = X.censusuniq\n"
             . " and M.censusuniq = X.censusuniq\n"
             . " and X.id = R.censusid\n"
        ...
        if ($set)
        {
            ...
            if ($dbug)
                $text = 'site|host|hid|ctime|stime|sid|revl|last|valu';
            else
            ...
            foreach ($set as $key => $row)
            {
                ...
                if ($dbug)
                    $args = array($site,$host,$hid,$clnt,$serv,$sid,$revl,$last,$valu);
                else
            ...
            if ($sids)
            {
                ...
                $srql = "select semid from ".$GLOBALS['PREFIX']."core.SemClears where semid in "
                    . "($sset)";
                $setsc = DSYN_DeleteSet($srql, constDataSetGConfigSemClears,
                    "semid", "force_update", 0, 1, constOperationDelete, $db);

                $ssql = "update ".$GLOBALS['PREFIX']."core.SemClears set\n"
                      . " revl = revl+1,\n"
                      . " valu = valu-1,\n"
                      . " last = $time\n"
                      . " where semid in ($sset)";
                if($setsc)
                {
                    $sres = redcommand($ssql,$db);
                    $snum = affected($sres,$db);

                    DSYN_UpdateSet($setsc, constDataSetGConfigSemClears,
                        "semid", $db);
                }
            }
            if (($snum) && ($hids))
...
WCRT;
    ...
    /*
     | If $env['custom'] is set to;
     | 2||3 call wiz_tools_finish()
     |    5 call wiz_nofty_finish()
    */
...
EPID;
   ...
   /*
    |  This is a little gross, but the spec calls for
    |  column sorting many pages in the same module.
    |  The alternative would be for each page to have
    |  it's own order function ... this would certainly
    |  be worth doing if we expect this to change
    |  frequently.
    */
   ...
   /*
    |  This is used for sorting the status tables.  We use 0-9 for
    |  sorting pcfg records and 8-15 for sorting wcfg records.
    |  The idea of sorting by schedule doesn't quite make total
    |  sense to me, but at least this will ensure that this
    |  will group like schedules together and the reverse
    ...
    */
    ...
    function stat_order($ord)
    {
        switch ($ord)
        {
            ...
            case  8: return 'lastupdate desc, mgroupid';   // ok for pcfg also
            case  9: return 'lastupdate, mgroupid desc';
...
LPID;
   ...
   /*
    |  The user needs to have access to at least one machine in any
    |  group in order to see the information.  He needs 100% control
    ...
    */
    ...
    function list_wcfg(&$env,$db)
    {
        ...
        if ($set)
        {
            ...
            $adm  = $env['admn'];
            $o    = "$self?act=lwid&ord";
            $pre  = ($ord == 34)? "$o=35" : "$o=34";   // mpre  34, 35
            $cat  = ($ord == 36)? "$o=37" : "$o=36";   // mcat  36, 37
            $name = ($ord == 38)? "$o=39" : "$o=38";   // name  38, 39
            $man  = ($ord == 40)? "$o=41" : "$o=40";   // man   40, 41
            $new  = ($ord == 42)? "$o=43" : "$o=42";   // new   42, 43
            $src  = ($ord == 44)? "$o=45" : "$o=44";   // src   44, 45
            $prop = ($ord == 46)? "$o=47" : "$o=46";   // prop  46, 47
    ...
    function list_pcfg(&$env,$db)
    {
        ...
        if ($set)
        {
            ...
            $ppre = ($ord ==  6)? "$o=7"  : "$o=6";    // ppre   6, 7
            $mpre = ($ord ==  8)? "$o=9"  : "$o=8";    // mpre   8, 9
            $pcat = ($ord == 10)? "$o=11" : "$o=10";   // pcat  10, 11
            $mcat = ($ord == 12)? "$o=13" : "$o=12";   // mcat  12, 13
            $pgrp = ($ord == 14)? "$o=15" : "$o=14";   // pgrp  14, 15
            $mgrp = ($ord == 16)? "$o=17" : "$o=16";   // mgrp  16, 17
            $ins  = ($ord == 18)? "$o=19" : "$o=18";   // ins   18, 19
            $ntfy = ($ord == 20)? "$o=21" : "$o=20";   // ntfy  20, 21
    ...
    function del_pcfg_perm(&$env,$gid,$jid,$db)
    {
        ...
        $pgrp = find_pgrp_jid($jid,$db);
        $pcfg = find_pcfg($gid,$jid,$db);
        /* If we are running from a wizard, we need to potentially handle
            multiple PatchConfig rows. */
        ...
        {
            /* We do not need to get specific patch categories or machine
                categories every time, since for the moment the wizard can only
                use type patch categories and the machine group should remain
                the same. */
            $tid = $mgrp['mcatid'];
            $kid = $pgrp['pcategoryid'];
            $mcat = find_mcat_tid($tid,$db);
...
HERE;
   ...
   /*
    |  Who should be allowed to delete a wcfg record?
    |  The spec doesn't actually say.
    |
    |  However, I'm allowing it in three cases.
    |
    |     1. The associated machine group is builtin.
    |     2. The user owns the associated machine group.
    |     3. The user has godlike powers.
    */
...
HERE;
   ...
   /*
    ...
    |
    |  if so ... proceed directly to editing it.
    |  otherwise, ask if you want to create it.
    */
   ...
   /*
    |  We'll attempt to inherit the schedule
    |  from some other existing pcfg ... this
    |  is so the wizard beta schedule will
    |  continue to work.
    */
...
HERE;
            ...
            $name = ($ord == 22)? "$o=23" : "$o=22";    // name  22, 23
            $defs = ($ord == 24)? "$o=25" : "$o=24";    // style 24, 25
            $bool = ($ord == 26)? "$o=27" : "$o=26";    // bool  26, 27
            $numb = ($ord == 28)? "$o=29" : "$o=28";    // numb  28, 29
            $glob = ($ord == 30)? "$o=31" : "$o=30";    // glob  30, 31
            $user = ($ord == 32)? "$o=33" : "$o=32";    // user  32, 33
...
HERE;
    ...
    function edit_pgrp_man(&$env,$db)
    {
        ...
        if ($set)
        {
           ...
           /*
            |  We set the type to an invalid value in our form.
            |  This is to prevent edit_pgrp_act from saving
            |  our values if we get redirected back here
            |  by a checkbox button.
            */
...
HERE;
   ...
   /*
    |  This could be very expensive, since it could
    |  potentially have to recalculate every machine
    |  configuration.
    |
    |  We know that a the patch source for a machine group
    |  has just been changed, so we want to delete certain
    |  patch status records.
    |
    |  Basically, we recalculate the correct wcfg for
    |  each member of the machine group.  Then
    |  we remove all the patch status records that
    |  should use this wcfg, and whose status is
    |  either detected or downloaded.
    */
    ...
    function copy_pcfg_cnf(&$env,$db)
    {
        ...
        if ($good)
        {
            $smgn = $smgp['name'];  // src machine grp name
            $dmgn = $dmgp['name'];  // dst machine grp name
            $spgn = $spgp['name'];  // src patch grp name
            $dpgn = $dpgp['name'];  // dst patch grp name

            $smcn = $smct['category'];  // src machine cat name
            $dmcn = $dmct['category'];  // dst machine cat name
            $spcn = $spct['category'];  // src patch cat name
            $dpcn = $dpct['category'];  // dst patch cat name
            $in   = indent(5);
            $xn   = indent(10);
...
HERE;
    ...
    */
    ...
    function update_wconfig(&$env,$db)
    {
        ...
        $mgrp = find_mgrp_own($env,$gid,$db);
        $scha = $chas * 3600;   /* convert hours to seconds */
   ...
   /*
    |  Force a rebuild of the patch groups, even if
    |  the dirty bit says it's not needed.
    |
    */
   ...
   /*
    |  Somebody clicked the "config" link on the patch
    |  page.  This attempts to create a configuraton
    |  for the 'All' machines group and patch group which
    |  contains this patch only.
    */
    ...
    function test_pconfig($env,$db)
    {
        ...
        if (($mach) && ($ptch))
        {
           ...
           /*
            |  This is the same as find_correct_pconfig
            |  except without the limit 1.
            */
   ...
   /*
    |  Note that affected() doesn't work
    |  when you're removing everything.
    */
    ...
    function debug_del_mmap($env,$db)
    {
        ...
        if ($auth)
        {
            /* Normally, before deletion, we would make sure no variables
                are set in the groups we are deleting.  Since we are deleting
                all membership in all groups this is impossible. */
   ...
   /*
    |  Note this table is ordered the same way that
    |  find_correct_pconfig does it.
    */
...
//      echo "<p>$tab: $num removed</p>";
    ...
    function reset_patch($env,$db)
    {
        ...
        /* This procedure used to destroy machine group and category info
            in the core database.  This was very dangerous and could cause
            a lot of problems, so this procedure no longer does this.  Plus,
            this is a special debug command and is not used regularly.
        */
    ...
    function stat_stra(&$env,$db)
    {
        ...
        if ($set)
        {
            ...
            $o    = "$self?act=pmth&ord";
            $name = ($ord == 0)? "$o=1" : "$o=0";   // name  0, 1
            $shed = ($ord == 2)? "$o=3" : "$o=2";   // shed  2, 3
            $ntfy = ($ord == 4)? "$o=5" : "$o=4";   // ntfy  4, 5
            $meth = ($ord == 6)? "$o=7" : "$o=6";   // meth  6, 7
            $date = ($ord == 8)? "$o=9" : "$o=8";   // date  8, 9
   ...
   /*
    |  Find all of just one type from the current
    |  set of of conjoined quadruplets (a/c/r/d).
    |
    |  The user should have access to at least one
    |  machine in the relevent machine group in
    |  order to see the machine group.
    */
   ...
   /*
    |  find_beta_group has a side effect of creating a user
    |  pcfg record if it doesn't exist already.  Normally
    |  that isn't a problem, but it can cause problems here.
    |
    |  But in this case we're just checking on the status
    |  and we know that if there is no user pcfg, we don't
    |  need to check further, there cannot be a beta group.
    */
   ...
   /*
    |  The user has to own at least one machine
    |  in the relevent machine group to be listed.
    |
    |  So, for example, sites and machines he has no
    |  access to will be excluded.
    */
    ...
    function stat_prop(&$env,$db)
    {
        ...
        if ($set)
        {
            ...
            $date = ($ord == 8)?  "$o=9"  : "$o=8";    // date  8, 9
            $prop = ($ord == 10)? "$o=11" : "$o=10";   // prop 10,11
            $keep = ($ord == 12)? "$o=13" : "$o=12";   // keep 12,13
            $name = ($ord == 14)? "$o=15" : "$o=14";   // name 14,15
   ...
   /*
    |  We would like to go to different places
    |  depending on the form contents.
    */
    ...
    function redirect_action($act,$frm,$post,$gid,$jid,$dgid,$djid)
    {
       ...
       /*
        |  Handle spooky javascript submit() calls.
        |  Do them first, since cancel should override.
        |
        |  awid: add_wcfg
        |  apid: add_pcfg
        |  ewid: edit_wconfig
       ...
       /*
        |  edit_pgrp_post (epgp) just goes on back to
        |  edit_pgrp_expr (epge) ... so we don't need
        |  any special javascript hacks.
        */
       ...
       /*
        |  We want the 'check all' and 'uncheck all' buttons to
        |  redirect the page back to itself.  We only do this
        |  for edit_pgrp_man() aka 'epgm';
        */
...
MENU;
    ...
    /*
    | build many of the $env vars that are similiar between
    | group and wu-confg.
    |
    | returns an array().
    */
    ...
    {
        $env = array();
        $env['sub']  = UTIL_GetStoredString('sub','');  // substate
        $env['url']  = UTIL_GetStoredString('url','');  // WUConfig.serverurl
        $env['txt']  = UTIL_GetStoredString('txt','');  // PatchConfig.notifytext, wiz_control
        $env['ord']  = UTIL_GetStoredInteger('ord',0);  // sort order
        $env['man']  = UTIL_GetStoredInteger('man',0);  // WUConfig.management
        $env['new']  = UTIL_GetStoredInteger('new',0);  // WUConfig.newpatches
        $env['src']  = UTIL_GetStoredInteger('src',0);  // WUConfig.patchsource
        $env['ins']  = UTIL_GetStoredInteger('ins',0);  // PatchConfig.installation
        $env['glob'] = UTIL_GetStoredInteger('glob',0); // PatchGroups.global
        $env['type'] = UTIL_GetStoredInteger('type',0); // PatchGroups.style
        $env['rusr'] = UTIL_GetStoredInteger('rusr',0); // PatchConfig.reminduser
        $env['pshd'] = UTIL_GetStoredInteger('pshd',0); // PatchConfig.preventshutdown

        $env['sdel'] = UTIL_GetStoredInteger('sdel',0); // PatchConfig.scheddelay
        $env['ssec'] = UTIL_GetStoredInteger('ssec',0); // PatchConfig.scheddelay
        $env['smin'] = UTIL_GetStoredInteger('smin',0); // PatchConfig.schedminute
        $env['shor'] = UTIL_GetStoredInteger('shor',0); // PatchConfig.schedhour
        $env['sday'] = UTIL_GetStoredInteger('sday',0); // PatchConfig.schedday
        $env['smon'] = UTIL_GetStoredInteger('smon',0); // PatchConfig.schedmonth
        $env['swek'] = UTIL_GetStoredInteger('swek',0); // PatchConfig.schedweek
        $env['srnd'] = UTIL_GetStoredInteger('srnd',0); // PatchConfig.schedrandom
        $env['styp'] = UTIL_GetStoredInteger('styp',0); // PatchConfig.schedtype

        $env['nmin'] = UTIL_GetStoredInteger('nmin',0); // PatchConfig.notifyminute
        $env['nhor'] = UTIL_GetStoredInteger('nhor',0); // PatchConfig.notifyhour
        $env['nday'] = UTIL_GetStoredInteger('nday',0); // PatchConfig.notifyday
        $env['nmon'] = UTIL_GetStoredInteger('nmon',0); // PatchConfig.notifymonth
        $env['nwek'] = UTIL_GetStoredInteger('nwek',0); // PatchConfig.notifyweek
        $env['nrnd'] = UTIL_GetStoredInteger('nrnd',0); // PatchConfig.notifyrandom
        $env['ntyp'] = UTIL_GetStoredInteger('ntyp',0); // PatchConfig.notifytype
        $env['nfal'] = UTIL_GetStoredInteger('nfal',0); // PatchConfig.notifyfail
        $env['nadv'] = UTIL_GetStoredInteger('nadv',0); // PatchConfig.notifyadvance
        $env['nsch'] = UTIL_GetStoredInteger('nsch',0); // PatchConfig.notifyschedule
        $env['mins'] = UTIL_GetStoredInteger('mins',0); // PatchConfig.notifyadvancetime
        $env['iday'] = UTIL_GetStoredInteger('iday',0); // WUConfig.installday
        $env['prop'] = UTIL_GetStoredInteger('prop',0); // WUConfig.propagate
        $env['hour'] = UTIL_GetStoredInteger('hour',3); // WUConfig.installhour
        $env['updc'] = UTIL_GetStoredInteger('updc',0); // WUConfig.updatecache
        $env['cday'] = UTIL_GetStoredInteger('cday',0); // WUConfig.cacheseconds
        $env['rest'] = UTIL_GetStoredInteger('rest',0); // WUConfig.restart
        $env['chan'] = UTIL_GetStoredInteger('chan',0); // WUConfig.chain
        $env['chas'] = UTIL_GetStoredInteger('chas',0); // WUConfig.chainseconds
        $env['scop'] = UTIL_GetStoredInteger('scop',constScopNone);
        $env['ctl']  = UTIL_GetStoredInteger('ctl', 0);

        $env['siz']  = UTIL_GetStoredInteger('siz', -1);  // wiz_control size
        $env['age']  = UTIL_GetStoredInteger('age', -1);  // wiz_control date
        $env['cmp']  = UTIL_GetStoredInteger('cmp', -1);  // wiz_control component
        $env['plt']  = UTIL_GetStoredInteger('plt', -1);  // wiz_control platform
        $env['pri']  = UTIL_GetStoredInteger('pri', -1);  // wiz_control priority
        $env['can']  = UTIL_GetStoredInteger('can', -1);  // wiz_control canuninstall
        $env['int']  = UTIL_GetStoredInteger('int', -1);  // wiz_control install
        $env['dtc']  = UTIL_GetStoredInteger('dtc', -1);  // wiz_control detect

        $env['text'] = UTIL_GetStoredString('text',''); // PatchGroups.search
        $env['name'] = UTIL_GetStoredString('name',''); // PatchCategories.category
    ...
    /*
    |  Determine were we came from.
    |  $page will be a constant set by the caller
    |  of controlGroupState().
    */
   ...
   /*
    ...
    | $qu  = user name
    | $db  = database handle
    | Returns the mgroupid, name, username
    | for the applicable group(s).
   */
    ...
    | $env  = global array
    | $db   = database
    | $mcat = array of machine categories
    |         ( mcatid => 5
    |           category => Wiz_SCOP_MC
    |           precedence => 3
    |           revl => 0 )
    |
    | This procedure is called from controlGroupState()
    | We will dynamically determine the menu options based
    | on the value of custom.
    |
    | Dec-08-05: We can access this code from scrpconf.php
    | as well, when we want to configure scrips for a group.
    | The user will have the ability to add edit remove groups
    | and clicking 'use' will return the user to scrpconf.php
    | so they can configure scrips and variables.
    */
    function wiz_mgrp_select(&$env,&$mcat,$db)
    {
       ...
       /*
        |  IE doesn't reload the page properly
        |  when we return via a button press.
        |  So, when the user wants to return to
        |  the notification they were previously
        |  editing, they must click a link,
        |  which will update the machine group
        |  list for includes, excludes & suspends
        |  to reflect any changes they made in the
        |  wizard.
       */
        switch($env['custom'])
        {
        ...
        /*
        |  If we are comming from wu-confg, the user can
        |  'edit' and 'use' the machine groups.
        |  If we are comming from groups (sites or tools)
        |  the user can  'edit' and 'remove' the machine groups.
        |  Both may add a 'new group'.
        */
        switch($env['custom'])
        {
                case constPageEntryAsset   : ;
...
SPAZ;
	    ...
	    $sref = "../config/syst.php?act=" . constDashStatus_SelectDisplay;
            ...
            foreach ($gids as $id => $grp)
            {
                ...
                //debug_note("mcatid($mcatid) mgroupid($id)");
    ...
    */
    ...
    {
    /* this is called when we come from /config/groups.php
    |  (OR /event/notify.php OR /asset/report.php)
    |  the state variable $act is set to 'wmgs' since we
    |  know the user is configuring a group of machines.
    |  We skip a few procedures that wu-confg.php would
    |  normally call before reaching this point. However
    |  we must set $mcatid. Do this now.
    |
    |  Since the page wiz_mgrp_select() cant be reached
    |  directly (unless we follow the wu-confg.php steps)
    |  we artificially set $act from groups.php
    |  to call wiz_meth_prep which sets its arguments and
    |  $act to the state it would be in if we reached it
    |  from wu-confg.php.
    |
    |  We can then re-use most of the wizard code,
    |  if custom equals 2 or 3.
    |  In this case, when custom = (2 || 3), we will
    |  also exit prior to the 'select updates' section
    |  of code.
    |  We only reach the MSUpdate options if the user
    |  began from the update:wizard link.
    */
        switch($env['custom'])
        {
	    case constDashStatus_SelectMachineGroup : ;
            ...
            /* from this point, wiz_mgrp_select()
            |  believes we reached it just as
            |  wu-confg would and we can continue
            |  along.
            */
        }
    ...
    /* GRPW_GetGroupScripLink

        Returns a link suitable for configuring a group's configurable
        variables.
    */
    ...
    /*
    | This procedure is called by /patch/wu-confg.php
    | and /config/groups.php and acts as our state machine.
    |
    | $act = what action we want to take
    */
    function controlGroupState($act, $env, $db)
    {
        if(@$env['delgroup']!=0)
        {
            /* Someone added a group and then clicked cancel - we need to
                delete this group */
   ...
   /*
    |  check to see if the appropriate group (which will
    |  either the "All" group or the user group for this
    |  user) has a configuration.  If so, then do the
    |  group update.  Otherwise, fall back on the old
    |  method of updating all the relevent sites one
    |  at a time.
    */
    ...
    function group_process(&$env,&$set,$scop,$var,$valu,$source,$db)
    {
       ...
       /*
        |  If there are old clients we'll just have
        |  to update them the old way, one site at
        |  a time.
        */
       ...
       /*
        |  Update all the new clients to use the value
        |  in the new machine group.
        */
    ...
    /* GRPW_BuildTypeSelect

        Creates a set of radio buttons and checkboxes for the wizard using
        patch group $wpgroupid.
    */
    function GRPW_BuildTypeSelect(&$env, $wpgroupid, $db)
    {
        ...
        foreach ($set as $key => $row)
        {
            /* We purposely invert the logic whenever the checkbox is clicked.
            */
            if($begin)
            {
            ...
            $text = $row['name'];
            /* We alter the text for Update to "Generic Update" and
                "Mandatory Update" to "Mandatory Generic Update".  This is a
                special case that is not used elsewhere. */
    ...
    /* GRPW_ProcessSelection

        Processes form input data for the wizard $wpgroupid for the controls
        created by GRPW_BuildTypeSelect.
    */
    function GRPW_ProcessSelection(&$env, $wpgroupid, $db)
    {
        ...
        /* We "cache" the delete sql statements until the very end - that way
            if an user removes an association and adds a new one the new one
            will still have a template to draw from. */
    ...
    /* GRPW_LocatePConfig
        ...
        Locates all relevant patch configuration rows that apply to a
        particular wizard patch group ($wpgroupid) and the current machine
        group (derived from $env).

        For most wizard operations, only the first patch configuration row
        is really needed, since the individual configurations returned by this
        procedure should be identical except for PatchConfig.pgroupid.
    */
    ...
    /* GRPW_DeriveMachineGroup

        Attempts to derive the current machine group using context information
        in $env.
    */
    ...
    /* GRPW_PrepareWizardUpdateForm

        Prepares a form for the wizard identified by $wpgroupid.  This is
        required for the controls created by GRPW_BuildTypeSelect to work.
    */
    ...
    /* GRPW_GetWizardCheckboxVals

        Checks the database for PatchConfig rows that have a wpgroupid of
        $wpgroupid and determines which check boxes should be checked/unchecked
        for the controls built by GRPW_BuildTypeSelect.
    */
    function GRPW_GetWizardCheckboxVals($env, $wpgroupid, $db)
    {
        ...
        if(!($row))
        {
            logs::log(__FILE__, __LINE__, 'GRPW_GetWizardCheckboxVals: failed to find mandatory '
                . 'category', 0);
            return $retSet;
        }
        ...
        /* Force the return order to match the $boxes array */
        foreach ($boxes as $key => $row)
        {
            $retSet[$row] = array();
        }
        ...
        foreach ($set as $key => $row)
        {
            /* Determine if a PatchConfig row exists for this particular
                PatchGroup, machine group, and wizard patch group (all three
            ...
            {
                /* $row2 meets the wizard and machine group criteria, see if
                    this configuration is also for this particular update type.
                */
            ...
            {
                /* Now, determine if this checkbox value should be permitted to
                    be clicked or not. */
    ...
    /* GRPW_ProcessAssocChange

        Adds or removes a type association to the wizard identified by
        $wpgroupid.
    */
    function GRPW_ProcessAssocChange(&$env, $wpgroupid, $str, $db)
    {
        ...
        else
        {
            ...
            $num = $num - 1;
            logs::log(__FILE__, __LINE__, "patch: deleted PatchConfig " . $set[$str]['pconfigid'],
                0);
        }
    ...
    /* GRPW_WizardPagingText

        Generates some common text for $wizard.
    */
    function GRPW_WizardPagingText($wizard)
    {
        $lower = strtolower($wizard);

        /* The critical wizard is a special case. */
        if($wizard=='Critical')
        {
    ...
    */
    function GRPW_AuditMachineChange($env, $sql2, $newcfg, $db)
    {
        ...
        if($changes)
        {
            ...
            if($err!=constAppNoErr)
            {
                logs::log(__FILE__, __LINE__, "PHP_AUDT_LogLocalAudit failed for MUM mgroup: $err",
                    0);
            }
        }
    }
