...
//         $sql = $db->prepare("INSERT INTO ".$GLOBALS['PREFIX']."core.`Dashboards` (`id`,`name`, `visualization`, `type`, `createdby`, `createdon`, `global`, `home`) VALUES (209,'Automation', 0, 1, 'admin', 1595245962, 1, 1);");
//         $sql->execute();
