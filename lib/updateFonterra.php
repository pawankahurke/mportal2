...
//         $sql = $db->prepare("INSERT INTO ".$GLOBALS['PREFIX']."core.`UserDashboards` (`id`, `did`, `name`, `type`, `visualization`, `createdby`, `createdon`, `global`, `home`) VALUES (907, NULL, 'Automation', 1, 0, 'admin', 1595245962, 1, 1);");
//         $sql->execute();
//         echo 'Inserted Default Entries Into '.$GLOBALS['PREFIX'].'core.DashboardTypes TABLE<br />';
//     }
