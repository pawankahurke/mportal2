...
class PHPExcel_Shared_String
{
	...
	{
		return str_replace(safe_array_keys(self::$_controlCharacters), array_values(self::$_controlCharacters), $value);
	}


	public static function ControlCharacterPHP2OOXML($value = '')
	{
		return str_replace(array_values(self::$_controlCharacters), safe_array_keys(self::$_controlCharacters), $value);
	}
	...
	public static function UTF8toBIFF8UnicodeShort($value, $arrcRuns = array())
	{
		...
		if (empty($arrcRuns)) {
			...
			$data .= pack('v', safe_count($arrcRuns));
			$data .= self::ConvertEncoding($value, 'UTF-16LE', 'UTF-8');
