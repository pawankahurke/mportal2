...
class PHPExcel_Shared_Excel5
{
	...
	public static function getDistanceX(PHPExcel_Worksheet $sheet, $startColumn = 'A', $startOffsetX = 0, $endColumn = 'A', $endOffsetX = 0)
	{
		$distanceX = 0;
				...
				$startColumnIndex = PHPExcel_Cell::columnIndexFromString($startColumn) - 1; 		$endColumnIndex = PHPExcel_Cell::columnIndexFromString($endColumn) - 1; 		for ($i = $startColumnIndex; $i <= $endColumnIndex; ++$i) {
	...
	public static function oneAnchor2twoAnchor($sheet, $coordinates, $offsetX, $offsetY, $width, $height)
	{
		...
		$x2 = ($width + 1)  / self::sizeCol($sheet, PHPExcel_Cell::stringFromColumnIndex($col_end))	 * 1024; 		$y2 = ($height + 1) / self::sizeRow($sheet, $row_end + 1)	 *  256; 
