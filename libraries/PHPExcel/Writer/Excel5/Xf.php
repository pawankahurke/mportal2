...
class PHPExcel_Writer_Excel5_Xf
{
	...
	function writeXf()
	{
		...
		$ifnt           = $this->_fontIndex;   		$ifmt           = $this->_numberFormatIndex;  
		$align          = $this->_mapHAlign($this->_style->getAlignment()->getHorizontal());       		$align         |= (int) $this->_style->getAlignment()->getWrapText()     << 3;
		...
		$icv            = $this->_fg_color;      		$icv           |= $this->_bg_color      << 7;

		$border1        = self::_mapBorderStyle($this->_style->getBorders()->getLeft()->getBorderStyle());          		$border1       |= self::_mapBorderStyle($this->_style->getBorders()->getRight()->getBorderStyle())         << 4;
		...
		$border2        = $this->_top_color;    		$border2       |= $this->_bottom_color   << 7;
	...
	private static $_mapFillType = array( PHPExcel_Style_Fill::FILL_NONE					=> 0x00,
										  ...
										  PHPExcel_Style_Fill::FILL_GRADIENT_LINEAR			=> 0x00,											  PHPExcel_Style_Fill::FILL_GRADIENT_PATH			=> 0x00,											);
