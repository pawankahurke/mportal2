...
class PHPExcel_Calculation_Financial {
	...
	public static function COUPNUM($settlement, $maturity, $frequency, $basis=0) {
		...
		switch ($frequency) {
			case 1: 					return ceil($daysBetweenSettlementAndMaturity / 360);
			case 2: 					return ceil($daysBetweenSettlementAndMaturity / 180);
			case 4: 					return ceil($daysBetweenSettlementAndMaturity / 90);
			case 6: 					return ceil($daysBetweenSettlementAndMaturity / 60);
			case 12: 					return ceil($daysBetweenSettlementAndMaturity / 30);
		}
		return PHPExcel_Calculation_Functions::VALUE();
	}	
	...
	public static function $DE($fractional_dollar = Null, $fraction = 0) {
	...
	public static function $FR($decimal_dollar = Null, $fraction = 0) {
	...
	public static function XIRR($values, $dates, $guess = 0.1) {
		...
		$guess = PHPExcel_Calculation_Functions::flattenSingleValue($guess);
		if (safe_count($values) != safe_count($dates)) return PHPExcel_Calculation_Functions::NaN();
	...
	public static function XNPV($rate, $values, $dates) {
		...
		$values	= PHPExcel_Calculation_Functions::flattenArray($values);
		$dates	= PHPExcel_Calculation_Functions::flattenArray($dates);
		$valCount = safe_count($values);
		if ($valCount != safe_count($dates)) return PHPExcel_Calculation_Functions::NaN();
