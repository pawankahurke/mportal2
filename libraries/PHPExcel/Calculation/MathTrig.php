...
class PHPExcel_Calculation_MathTrig
{
	...
	public static function GCD()
	{
		...
		$allValuesCount = safe_count($allValuesFactors);
		if ($allValuesCount == 0) {
			return 0;
		}
		...
		$mergedArrayValues = safe_count($mergedArray);
		if ($mergedArrayValues == 0) {
			...
			$keys = safe_array_keys($mergedArray);
			$key = $keys[0];
	...
	public static function SUMPRODUCT()
	{
		...
		$wrkCellCount = safe_count($wrkArray);
	...
	public static function SUMX2MY2($matrixData1, $matrixData2)
	{
		...
		$count1 = safe_count($array1);
		$count2 = safe_count($array2);
		if ($count1 < $count2) {
			$count = $count1;
		} else {
			$count = $count2;
