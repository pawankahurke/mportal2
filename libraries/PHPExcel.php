...
class PHPExcel
{
        ...
        switch ($What) {
            ...
            case 'types':
                if (is_array($this->_ribbonBinObjects) && array_key_exists('data', $this->_ribbonBinObjects) && is_array($this->_ribbonBinObjects['data'])) {
                    $tmpTypes = safe_array_keys($this->_ribbonBinObjects['data']);
    ...
    {
        $worksheetCount = safe_count($this->_workSheetCollection);
    ...
    public function removeSheetByIndex($pIndex = 0)
    {
        ...
        $numSheets = safe_count($this->_workSheetCollection);
        ...
        if (($this->_activeSheetIndex >= $pIndex) &&
            ($pIndex > safe_count($this->_workSheetCollection) - 1)
        ) {
            --$this->_activeSheetIndex;
        }
    }
    ...
    {
        return safe_count($this->_workSheetCollection);
    }
    ...
    public function addExternalSheet(PHPExcel_Worksheet $pSheet, $iSheetIndex = null)
    {
        ...
        $countCellXfs = safe_count($this->_cellXfCollection);
    ...
    public function addCellXf(PHPExcel_Style $style)
    {
        ...
        $style->setIndex(safe_count($this->_cellXfCollection) - 1);
    }


    public function removeCellXfByIndex($pIndex = 0)
    {
        if ($pIndex > safe_count($this->_cellXfCollection) - 1) {
    ...
    public function addCellStyleXf(PHPExcel_Style $pStyle)
    {
        ...
        $pStyle->setIndex(safe_count($this->_cellStyleXfCollection) - 1);
    }


    public function removeCellStyleXfByIndex($pIndex = 0)
    {
        if ($pIndex > safe_count($this->_cellStyleXfCollection) - 1) {
