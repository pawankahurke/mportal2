...
csrf_check_custom();
$_SESSION['windowtype'] = 'softwaredistributionconfig';
$_SESSION['currentwindow'] = 'softwaredistributionconfig';

require_once '../layout/header.php';
require_once '../layout/sidebar.php';
require_once '../layout/rightmenu.php';
require_once 'swd_config_html.php';
...
<?php
$res = nhRole::checkModulePrivilege('softwaredistributionconfig');
if ($res) {
?>
...
<script>
    ...
    $('#pageName').html('Software Distribution Configuration');
</script>
