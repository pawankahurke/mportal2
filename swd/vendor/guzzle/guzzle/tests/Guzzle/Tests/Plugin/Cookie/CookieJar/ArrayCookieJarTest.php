...
class ArrayCookieJarTest extends \Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testStoresAndRetrievesCookies()
    {
        ...
        $this->assertEquals(3, safe_count($this->jar));
        $this->assertEquals(3, safe_count($this->jar->getIterator()));
    ...
    public function testIsSerializable()
    {
        ...
        $this->assertEquals(1, safe_count($data));

        $a = new ArrayCookieJar();
        $a->unserialize($serialized);
        $this->assertEquals(1, safe_count($a));
    }
    ...
    public function testRemovesSelectively()
    {
        ...
        $this->assertEquals(2, safe_count($this->jar));
        ...
        $this->assertEquals(1, safe_count($this->jar));

        // Remove cookie by name
        $this->jar->remove(null, null, 'test');
        $this->assertEquals(0, safe_count($this->jar));
    }
    ...
    public function testAddsCookiesFromResponseWithNoRequest()
    {
        ...
        $this->assertEquals(3, safe_count($this->jar));
        $this->assertEquals(1, safe_count($this->jar->all(null, null, 'fpc')));
        $this->assertEquals(1, safe_count($this->jar->all(null, null, 'FPCK3')));
        $this->assertEquals(1, safe_count($this->jar->all(null, null, 'CH')));
    }
    ...
    public function testReturnsCookiesMatchingRequests($url, $cookies)
    {
        ...
        $this->assertEquals(safe_count($cookies), safe_count($results));
