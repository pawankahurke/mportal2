...
class CurlMultiTest extends \Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testRequestsCanBeAddedAndCounted()
    {
        ...
        $this->assertEquals(2, safe_count($multi));
    }
    ...
    public function testSendsThroughCurlAndAggregatesRequestExceptions()
    {
        ...
        try {
            ...
            $this->assertEquals(1, safe_count($e));
            ...
            $this->assertEquals(1, safe_count($e->getFailedRequests()));
            $this->assertEquals(2, safe_count($e->getSuccessfulRequests()));
            $this->assertEquals(3, safe_count($e->getAllRequests()));
        }
    }
    ...
    public function testRemovesQueuedRequestsAddedInTransit()
    {
        ...
        $r->send();
        $this->assertEquals(1, safe_count($this->getServer()->getReceivedRequests(false)));
    }
    ...
    public function testCatchesExceptionsBeforeSendingSingleRequest()
    {
        ...
        try {
            ...
            $this->assertEquals(0, safe_count($multi));
        }
    }
    ...
    public function testDoesNotThrowExceptionsWhenRequestsRecoverWithRetry()
    {
        ...
        $multi->add($request);
        $multi->send();
        $this->assertEquals(0, safe_count($this->getServer()->getReceivedRequests(false)));
    }
