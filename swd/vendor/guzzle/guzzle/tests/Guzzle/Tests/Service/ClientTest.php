...
class ClientTest extends \Guzzle\Tests\GuzzleTestCase
{
    ...
    public function testWrapsMultipleCommandExceptions()
    {
        ...
        try {
            ...
            $this->assertEquals(2, safe_count($e->getFailedRequests()));
            $this->assertEquals(2, safe_count($e->getSuccessfulRequests()));
            $this->assertEquals(2, safe_count($e->getFailedCommands()));
            $this->assertEquals(2, safe_count($e->getSuccessfulCommands()));
