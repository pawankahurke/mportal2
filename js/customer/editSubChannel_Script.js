...
//    }
    ...
    if (isReqFieldsFilled == true && isChecked == true) {
        $("#edit_subchannel_success").html('<img src="../images/ajax-login.gif" class="loadhome" alt="loading..." style="width:auto !important;padding-left:22% !important;"/>');
        $.ajax({
            url: 'addCustomerModel.php?function=updateSubChannel',
            data: m_data,
            processData: false,
            contentType: false,
            type: 'POST',
            ...
            success: function(response) {
              ...
              $("#edit_subchannel_success").html(response.msg);
              setTimeout(function(){ 
            ...
            error: function(response) {
                $("#edit_subchannel_success").html("Error Occurred");
            }
        });
