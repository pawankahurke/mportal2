...
function enableOptions(rowId){
    ...
    sitesGrid = $('#msp_Sites_Grid').DataTable({
        ...
        ajax: {
            url: "../lib/l-msp.php?function=MSP_GetCustomerSitesGrid&custid="+sel_CustomerEid +"&csrfMagicToken=" + csrfMagicToken,
            type: "POST"
        },
        columns: [
            {"data": "sites"},
...
function getCustomerDetails() {
    ...
    m_data.append('eid', sel_Customer.split("---")[0]);
    m_data.append("csrfMagicToken",csrfMagicToken);
    $.ajax({
...
function exportAllCustomers() {
    ...
    location.href='../lib/l-entp.php?function=ENTP_exportCustomerData' +"&csrfMagicToken=" + csrfMagicToken;
}
