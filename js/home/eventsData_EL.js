...
function eventsiteinformationlevel() {
    ...
    $.ajax({
        url: "sitefunctions_EL.php?function=eventlistData&host=" + machine + '&cust=' + site,
        type: "POST",
        dataType: "json",
        data: { 'csrfMagicToken': csrfMagicToken },
...
function eventListAllLevel() {
    ...
    /*$.ajax({
     url: "sitefunctions_EL.php?function=eventlistallData",
     type: "POST",
     dataType: "json",
     success: function (gridData) {
     $(".se-pre-con").hide();
...
function exporteventlist() {
    ...
    window.location.href = 'sitefunctions_EL.php?function=eventexportlist&host=' + machine + '&cust=' + site;
}
...
function eventdetils() {
    ...
    if (eid == '') {
        ...
        $.ajax({
            url: "sitefunctions_EL.php?function=eventDetailPopup&eid=" + eid,
            type: "POST",
            dataType: "json",
            data: { 'csrfMagicToken': csrfMagicToken },
            async: true,
...
var level = $('#searchValue').val();
    ...
    window.location.href = 'sitefunctions_EL.php?function=exportExcelallData';
}
}
...
function eventDetail(idx) {
    if (idx == '') {
        ...
        $.ajax({
            url: "sitefunctions_EL.php?function=eventDetailPopup&eid=" + idx,
            type: "POST",
            dataType: "json",
            data: { 'csrfMagicToken': csrfMagicToken },
            async: true,
...
//    else if((exec == '') || (exec == 'undefined')){
//        $('#errmsg').html('Please Enter a Executable search criteria');
//        return false;
//    }else if((title == '') || (title == 'undefined')){
//        $('#errmsg').html('Please Enter a Tittle');
//        return false;
//    }else if((text1 == '') || (text1 == 'undefined')){
//        $('#errmsg').html('Please Enter a Text1');
//        return false;
//    }else if((text2 == '') || (text2 == 'undefined')){
//        $('#errmsg').html('Please Enter a Text2');
//        return false;
//    }else if((text3 == '') || (text3 == 'undefined')){
//        $('#errmsg').html('Please Enter a Text3');
//        return false;
//    }else if((text4 == '') || (text4 == 'undefined')){
//        $('#errmsg').html('Please Enter a Text4');
//        return false;
//    }else if((idval == '') || (idval == 'undefined')){
//        $('#errmsg').html('Please Enter a ID');
//        return false;
//    }
    ...
    /*$(".se-pre-con").show();
     $.ajax({
     url: "sitefunctions_EL.php?function=eventlistallData&" + query_string,
     type: "POST",
     dataType: "json",
     success: function (gridData) {
     $(".se-pre-con").hide();
