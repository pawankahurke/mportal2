...
//        "info":     false,
        ...
        initComplete: function(settings, json) {
            var reportname = $('#reportTable tbody tr:eq(0)')[0]['firstChild']['innerText'];
            $('#reportTable tbody tr:eq(0)').addClass("selected");
            name = reportname;
            id = $('#reportTable tbody tr:eq(0)')[0].id;
            loadInformationPortal(reportname, id);
        },
...
function submitReport() {
    ...
    json_data.csrfMagicToken = csrfMagicToken;
