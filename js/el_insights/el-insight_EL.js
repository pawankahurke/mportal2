...
function submitSection() {
    ...
    $.ajax({
        url: "../el_insights/el-reportFunction_EL.php",
        type: 'POST',
        data: data,
        success: function (data) {
            var res = data.trim();
...
function renderGridData(res) {
    ...
    for (var i = 0; i < res.length; i++) {
        ...
        if (o.servertime.length > 12) {
            ...
            servertime = d.getDate() + '/' + (d.getMonth() + 1) + '/' + d.getFullYear() + ' ' + d.getHours() + ':' + d.getMinutes();
        }
...
function renderGridDataNew() {
    ...
    eventDetails = $('#eventDetail').DataTable({
        ...
        ajax: {
            url: "el-reportFunction_EL.php?function=1&functionToCall=eventReportFunction",
            type: "POST"
        },
...
function eventFunctionCall() {
    ...
    /*var data = {"function": 1, "functionToCall": "eventReportFunction"};
...
function exportExcelReport() {
    ...
    if(level === 'All') {
        ...
        location.href = "el-exportReport_EL.php";
    }
}
