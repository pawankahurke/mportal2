...
{ 
  ...
  //dynamic data 
  this.isOpen = true 
  this.iconSrc = "../vendors/images/ftv2folderopen.gif"   
  this.iconSrcClosed = "../vendors/images/ftv2folderclosed.gif"   
...
{ 
  ...
  if (level>0) 
    ...
    { 
	  nodeIconName = "../vendors/images/ftv2mlastnode.gif"
	  if (this.nChildren == 0)
		 nodeIconName = "../vendors/images/ftv2lastnode.gif"
      ...
      leftSide = leftSide + "<td valign=top><img src='" + "../vendors/images/ftv2blank.gif' width=16 height=22></td>"  
      this.isLastNode = 1 
    } 
    else 
    { 
	  nodeIconName = "../vendors/images/ftv2mnode.gif"
	  if (this.nChildren == 0)
		nodeIconName = "../vendors/images/ftv2node.gif"
      this.renderOb(leftSide + "<td valign=top background=" + "../vendors/images/ftv2vertline.gif>" + auxEv + "<img name='nodeIcon" + this.id + "' id='nodeIcon" + this.id + "' src='" + nodeIconName + "' width=16 height=22 border=0></a></td>") 
      leftSide = leftSide + "<td valign=top background=" + "../vendors/images/ftv2vertline.gif><img src='" + "../vendors/images/ftv2vertline.gif' width=16 height=22></td>" 
      this.isLastNode = 0 
    } 
  else 
    this.renderOb("") 
...
{ 
  ...
  {
	  doc.write("<img src=" + "../vendors/images/ftv2blank.gif height=2 width=2>")
  }
...
{   
  ...
  { 
	if (folder.nodeImg && folder.nChildren > 0) 
	  if (folder.isLastNode) 
		folder.nodeImg.src = "../vendors/images/ftv2mlastnode.gif" 
	  else 
		folder.nodeImg.src = "../vendors/images/ftv2mnode.gif" 
	if (USEICONS)
  ...
  { 
	if (folder.nodeImg && folder.nChildren > 0) 
	  if (folder.isLastNode) 
		folder.nodeImg.src = "../vendors/images/ftv2plastnode.gif" 
	  else 
		folder.nodeImg.src = "../vendors/images/ftv2pnode.gif" 
	if (USEICONS)
...
{ 
  ...
  this.iconSrc = "../vendors/images/ftv2doc.gif" 
  // ADDED BY NINA
  this.dataid = dataid 
...
{  
  ...
  if (level>0) 
    ...
    { 
      this.renderOb(leftSide + "<td valign=top><img src='" + "../vendors/images/ftv2lastnode.gif' width=16 height=22></td>") 
      leftSide = leftSide + "<td valign=top><img src='" + "../vendors/images/ftv2blank.gif' width=16 height=22>"  
    } 
    else 
    { 
      this.renderOb(leftSide + "<td valign=top background=" + "../vendors/images/ftv2vertline.gif><img src='" + "../vendors/images/ftv2node.gif' width=16 height=22></td>") 
      leftSide = leftSide + "<td valign=top background=" + "../vendors/images/ftv2vertline.gif><img src='" + "../vendors/images/ftv2vertline.gif' width=16 height=22></td>" 
    } 
  else 
    this.renderOb("")   
...
{ 
  ...
  {
	  doc.write("<img src=" + "../vendors/images/ftv2blank.gif height=2 width=3>")
  }
  
  // ADDED BY NINA
  if (USECHECKBOXES) 
  {
	  doc.write("<input type='checkbox' name='display_" + this.dataid + "' value='1' " + this.checked + " style='margin-right:10px;' >")
  }
...
function preLoadIcons() {
	var auxImg
	auxImg = new Image();
	auxImg.src = "../vendors/images/ftv2vertline.gif";
	auxImg.src = "../vendors/images/ftv2mlastnode.gif";
	auxImg.src = "../vendors/images/ftv2mnode.gif";
	auxImg.src = "../vendors/images/ftv2plastnode.gif";
	auxImg.src = "../vendors/images/ftv2pnode.gif";
	auxImg.src = "../vendors/images/ftv2blank.gif";
	auxImg.src = "../vendors/images/ftv2lastnode.gif";
	auxImg.src = "../vendors/images/ftv2node.gif";
	auxImg.src = "../vendors/images/ftv2folderclosed.gif";
	auxImg.src = "../vendors/images/ftv2folderopen.gif";
	auxImg.src = "../vendors/images/ftv2doc.gif";
}
